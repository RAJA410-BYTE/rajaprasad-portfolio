      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 animate-slideInLeft">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4 stagger-1 animate-fadeInUp">
              Raja Prasad
            </h1>
            <h2 className="text-2xl md:text-3xl text-blue-600 font-semibold mb-6 stagger-2 animate-fadeInUp">
              Full Stack Web Developer & Problem Solver
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-8 stagger-3 animate-fadeInUp">
          ...
          <div className="order-1 md:order-2 flex justify-center animate-slideInRight">
            <div className="relative hero-image">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-600 rounded-2xl -z-10 animate-pulse"></div>
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-gray-900 rounded-2xl -z-10 animate-pulse" style={{ animationDelay: '0.3s' }}></div>
            </div>
          </div>
        </div>
      </div>
